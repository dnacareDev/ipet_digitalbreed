	...
	public JSONArray getPcaListJson(String permissionUid, String varietyid) throws Exception
	{
		 ...
		 JSONArray jsonArray = new JSONArray();
			...
			try{
				...
				String sql="select no, uploadpath, filename,resultpath, comment, status, cropid, jobid, DATE_FORMAT(cre_dt, '%Y-%m-%d') AS cre_dt  from pca_info_t where creuser='"+permissionUid+"' and varietyid='"+varietyid+"' order by no desc;";
