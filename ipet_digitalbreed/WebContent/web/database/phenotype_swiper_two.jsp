...
<%
	...
	String sampleno = request.getParameter("two_sampleno");
...
<body>
	...
	<script>document.getElementById("card-header_two").innerHTML = "<font size='3px'>Sample Name : <b><%=samplename%></b></font>"; </script>

	<div id="photo_two_desc" style="height: 237px;" class="swiper-progress swiper-container">
