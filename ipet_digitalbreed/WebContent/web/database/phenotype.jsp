						                        ...
						                        <div class="card-content">
						                            <div class="card-body">
						                                <div class="swiper-navigations swiper-container">
						                                    <div style="height: 250px;" class="swiper-wrapper">
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;" src="../../uploads/database/phenotype_img/1/banner-7.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-4.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-14.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-3.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-2.jpg" alt="banner">
						                                        </div>
						                                    </div>
						                                    <!-- Add Arrows -->
						                    ...
						                    <div class="card ">
						                        ...
						                        <div class="card-content">
						                            <div class="card-body">
						                                <div class="swiper-navigations swiper-container">
						                                    <div style="height: 250px;" class="swiper-wrapper">
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%; width:100%;" src="../../uploads/database/phenotype_img/1/banner-7.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%; width:100%;"  src="../../uploads/database/phenotype_img/1/banner-4.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%; width:100%;"  src="../../uploads/database/phenotype_img/1/banner-14.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%; width:100%;"  src="../../uploads/database/phenotype_img/1/banner-3.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 250px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%; width:100%;"  src="../../uploads/database/phenotype_img/1/banner-2.jpg" alt="banner">
						                                        </div>
						                                    </div>
						                                    <!-- Add Arrows -->
						                                    <div class="swiper-button-next"></div>
									...
									<div class="card-content">				
			                            <div class="card-body">
			                                <div class="row">
			                              	...
			                              	<div id="myGrid" class="ag-theme-alpine" style="margin: 0 auto;width: 98%;height:460px;" ></div><br>
			                                <button class="btn btn-warning mr-1 mb-1" style="margin-left: 20px;" onclick="addRow()"><i class="feather icon-corner-up-left"></i> Tool Box</button>
			                                <button class="btn btn-success mr-1 mb-1"  style="float: right;" data-toggle="modal"  data-backdrop="false"  data-target="#backdrop"><i class="feather icon-upload"></i> Upload</button>
											<button class="btn btn-danger mr-1 mb-1" style="float: right;" onclick="getSelectedRowData()"><i class="feather icon-trash-2"></i> Del</button>  	
			                            </div>
						                ...
						                <section id="component-swiper-navigations">
						                    <div class="card ">
						                        ...
						                        <div class="card-content">
						                            <div class="card-body">
						                                <div class="swiper-navigations swiper-container">
						                                    <div style="height: 234px;" class="swiper-wrapper">
						                                        <div style="height: 234px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;" src="../../uploads/database/phenotype_img/1/banner-7.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 234px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-4.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 234px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-14.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 234px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-3.jpg" alt="banner">
						                                        </div>
						                                        <div style="height: 234px;" class="swiper-slide"> <img class="img-fluid" style="height: 100%;"  src="../../uploads/database/phenotype_img/1/banner-2.jpg" alt="banner">
						                                        </div>
						                                    </div>
						                                    <!-- Add Arrows -->
						                                    <div class="swiper-button-next"></div>
									...
									<div class="col-lg-12 col-12">                                    
						                ...
						                <section id="component-swiper-navigations">
						                    <div class="card ">
						                        ...
						                        <div class="card-content">
						                            <div id="phenograph" class="card-body">
						                          		chart position
						                            </div>
						                        </div>
						                    </div>
