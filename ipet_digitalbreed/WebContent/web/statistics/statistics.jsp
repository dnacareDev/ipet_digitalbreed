...
<%
	...
	useSize = Math.round(roots[0].getUsableSpace() / Math.pow(1024, 3) * 100) / 100.0;
                    ...
                    <div class="card">
                        <div class="card-content">
                            <div class="card-body">
                                	...
                                	<div class="col-2">
                                		<div class="m-1 bg-light">
                                			...
                                			<%
	                                         	try{
	                                         		ipetdigitalconndb.stmt = ipetdigitalconndb.conn.createStatement();
	                                         		//String genotypeCountSql = "SELECT count(*) as count FROM vcfdata_info_t where where a.creuser='"+permissionUid+"' and a.varietyid='"+varietyid+ ";";
	                                         		String sql = "SELECT count(*) as count FROM vcfdata_info_t;";
	                                         		ipetdigitalconndb.rs=ipetdigitalconndb.stmt.executeQuery(sql);
	                                         		while (ipetdigitalconndb.rs.next()) { 	
	                                         			out.println("<div class='col-12'><h1>"+ipetdigitalconndb.rs.getString("count")+"</h1></div>");
	                                         		}
	                                         	}catch(Exception e){
	                                         		System.out.println(e);
	                                         	}
                                	...
                                	<div class="col-2">
                                		<div class="m-1 bg-light">
                                			...
                                			<%
	                                			try{
	                                         		ipetdigitalconndb.stmt = ipetdigitalconndb.conn.createStatement();
	                                         		String sql = "SELECT count(*) as count FROM sampledata_info_t;";
	                                         		ipetdigitalconndb.rs=ipetdigitalconndb.stmt.executeQuery(sql);
	                                         		while (ipetdigitalconndb.rs.next()) { 	
	                                         			out.println("<div class='col-12'><h1>"+ipetdigitalconndb.rs.getString("count")+"</h1></div>");
	                                         		}
                                	...
                                	<div class="col-2">
                                		<div class="m-1 bg-light">
                                			...
                                			<%
	                                			try{
	                                         		ipetdigitalconndb.stmt = ipetdigitalconndb.conn.createStatement();
	                                         		String sql = "SELECT count(*) as count FROM gwas_info_t;";
	                                         		ipetdigitalconndb.rs=ipetdigitalconndb.stmt.executeQuery(sql);
	                                         		while (ipetdigitalconndb.rs.next()) { 	
	                                         			out.println("<div class='col-12'><h1>"+ipetdigitalconndb.rs.getString("count")+"</h1></div>");
	                                         		}
                                ...
                                <div class="row">
                                	<div class="col-8">
                                		<div id="myGrid" class="ag-theme-alpine" style="margin: 0 auto;width: 98%;height:320px;"></div>
                                	</div>
                                	<div class="col-4">
                                		<div class="m-1 border">Photo</div>
                                	</div>
                                </div>							                              
                            </div>
                        </div>
