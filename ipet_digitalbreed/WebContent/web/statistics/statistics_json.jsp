...
<%
	...
	try{
		...
		String filter_sql = "select manufacture as category, filename, '-' as comment, jobid, DATE_FORMAT(cre_dt, '%Y-%m-%d') as cre_dt from genotype_filter_t where varietyid = '" +varietyid+ "' and status=1";
