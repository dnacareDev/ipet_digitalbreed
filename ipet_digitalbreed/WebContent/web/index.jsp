                ...
                <section class="row flexbox-container">
                    <div class="col-xl-8 col-11 d-flex justify-content-center">
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div  style="background-color: #c2ca9a" class="col-lg-6 d-lg-block d-none text-center align-self-center px-1 py-0">
                                    <img src="../images/main_bg.jpg" alt="logo">
                                </div>
                                <div class="col-lg-6 col-12 p-0">
                                    <div class="card rounded-0 mb-0 px-1" style="height: 435px;">
                                        <div class="card-header pb-1">
                                            <div class="card-title" style="margin-top:40px">
                                                <h3 class="mb-2">Digital Breeding System</h3>
                                            </div>
                                        </div>
