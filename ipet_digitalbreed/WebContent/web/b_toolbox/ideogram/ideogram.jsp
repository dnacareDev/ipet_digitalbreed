...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">&nbsp;Ideogram</h2>
   											...
   											<div role='tabpanel' class='tab-pane active' id='pill1' aria-expanded='true' aria-labelledby='base-pill1'>
   												<div class="row">
	   												<div class="col-12 col-xl-6">
	   													<div id="Density_Grid" class="ag-theme-alpine" style="margin: 0px auto; width: 100%; height:435px;"></div>
	   												</div>
	   												<div class="col-12 col-xl-6">
   											...
   											<div class='tab-pane' id='pill2' aria-expanded='true' aria-labelledby='base-pill1'>
   												<div class="row">
	   												<div class="col-12 col-xl-5">
	   													<div id="Ideogram_Grid" class="ag-theme-alpine" style="margin: 0px auto; width: 100%; height:435px;"></div>
	   												</div>
	   												<div class="col-12 col-xl-7">
		   												<iframe src = '' height='500px' width='100%' frameborder='0' border='0' scrolling='yes' bgcolor=#EEEEEE bordercolor='#FF000000' marginwidth='0' marginheight='0' id='pill2_frame' onload='hideSpinner(); gridOptions.api.sizeColumnsToFit();'></iframe>
	   												</div>
   												</div>
   											</div>
   										</div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header bg-warning white">
                    <h4 class="modal-title" id="myModalLabel5">Ideogram New Analysis</h4>
					    ...
					    <div class="form-body">
					        <div class="row">
					            ...
					            <div class="col-md-12 col-12 mb-1">
					            	<div class="row">
										<div class="col-4" style="margin-top:2%">CMPlot bin size(bp)</div>
										<div class="col-8">
											<input type="number" class="form-control" id="CM_Plot_Bin_Size" name="CM_Plot_Bin_Size" value="10000" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" />
										</div>
									</div>
					            </div>
					            <div class="col-12">
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../css/app-assets/js/scripts/ag-grid/ag-grid_ideogram.js"></script>
...
<script type="text/javascript">   
    ...
    async function execute() {
    	...
    	let comment = $('#comment').val();
   		...
   		const jobid_ideogram = await fetch('../../getJobid.jsp').then((response) => response.text());
   		...
   		//const jobuploadpathid = vcfSelect.options[vcfSelect.selectedIndex].dataset.uploadpath;
   		...
   		const CM_Plot_Bin_Size = document.getElementById('CM_Plot_Bin_Size').value;
    	...
    	fetch(`./ideogram_analysis.jsp`, {
    		method: "POST",
   			...
   			body: new URLSearchParams({
					...
					"refgenome_id": refgenome_id,
					"annotation_filename": annotation_filename,
					"CM_Plot_Bin_Size": CM_Plot_Bin_Size,
   			})
    	});
