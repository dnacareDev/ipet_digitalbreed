...
<body class="horizontal-layout horizontal-menu 2-columns  navbar-floating footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
	...
	<jsp:include page="../../../css/menu.jsp" flush="true">
		<jsp:param value="anno" name="menu_active"/>
	</jsp:include>
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">&nbsp;Annotation</h2>
   								...
   								<div class='row'>
   									<div class='col-12'>
   										<ul class='nav nav-pills nav-active-bordered-pill'>
   											<li class='nav-item'><a class='nav-link active' id='info' data-toggle='pill' href='#pill1' aria-expanded='true'>SnpEff</a></li>
   										</ul>
    ...
    <!-- BEGIN: Page JS-->
    <script src="../../../css/app-assets/js/scripts/ag-grid/ag-grid_anno.js"></script>
...
<script type="text/javascript">   
    ...
    function switchImpact(impact) {
    	console.log(impact);
    	
    	if(!(impact == "HIGH" || impact == "MODERATE" || impact == "LOW" || implact == "MODIFIER")) {
    		return;
    	}
    	
    	if(document.querySelectorAll("[data-impact]:checked").length = 4) {
    		document.querySelectorAll("[data-impact]:checked").forEach((node) => {
    			node.checked = node.dataset.impact == impact;
    		});
    	}
    }
	...
	function SnpEff_filter() {
		...
		//document.getElementById('pill1_frame').contentWindow.printImpact("aaa");
		...
		gridOptions2.api.setFilterModel(impactFilter);
    ...
    async function execute() {
    	...
    	let comment = $('#comment').val();
   		...
   		const jobid_anno = await fetch('../../getJobid.jsp').then((response) => response.text());
