...
<%
	...
	*/
	...
	sql += "values((select cropid from variety_t where varietyid='"+varietyid+"'), '"+varietyid+"', 0, '"+comment+"', '" +analysis_number+ "', '" +traitname+ "', '" +db_savePath+"','"+db_outputPath+"', '"+jobid_anova+"','" +permissionUid+ "',now());";
