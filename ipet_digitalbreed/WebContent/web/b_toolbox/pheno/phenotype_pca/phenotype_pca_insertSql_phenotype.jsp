...
<%
	...
	*/
	...
	String db_outputPath = "/ipet_digitalbreed/result/Breeder_toolbox_analyses/pheno/phenotype_pca/";
	
	String log_sql="insert into log_t(logid, cropid, varietyid, menuname, comment, cre_dt) values('" +permissionUid+ "', (select cropid from variety_t where varietyid='"+varietyid+"'),'"+varietyid+"','Phenotype PCA', 'New analysis', now());";
	...
	String sql = "insert into phenotype_pca_t (cropid, varietyid, status, comment, analysis_number, phenotype, uploadpath, resultpath, jobid, creuser, cre_dt) ";
