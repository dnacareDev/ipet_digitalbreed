...
<%
	...
	String uploadPath = rootFolder+"uploads/database/db_input/"+jobid+"/";
	...
	*/
	...
	File chrFile = new File(uploadPath+filename+".max_variant.csv");
	...
	try {
		...
		while( (line = br.readLine()) != null) {
			...
			JsonObject jsonObject = new JsonObject();
			jsonObject.addProperty("chromosome", arr[0]);
			jsonObject.addProperty("length", Integer.parseInt(arr[1]));
