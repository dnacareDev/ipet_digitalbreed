...
<%
	...
	cmd += "train_pheno_1-9.txt" +" "+ traitname_keys +" "+ MAXNA +" "+ MAF;
...
<%!
	public void writePhenotypeTxt(String permissionUid, String variety_id, String phenotypePath, String cre_date, String inv_date) throws SQLException {
		...
		try {
			File phenotypeTxt = new File(phenotypePath+"train_pheno_1-9.txt");
			...
			try {
				...
				String sql = "select group_concat( b.value SEPARATOR  ',' ) as val from sampledata_info_t a";
				sql += " inner join sampledata_traitval_t b on a.sampleid=b.sampleid";
				sql += " where b.sampleid like '%s-000%' and a.varietyid='"+ variety_id +"' and a.creuser ='"+ permissionUid +"'";
				if(!cre_date.isEmpty()) {
...
<%! 
	...
	File file = new File(phenotypePath+"train_pheno_1-9.txt");
